...
function verifica(casa){
    ...
    if(casas[casa]==9){
        ...
        if(vez==1){
            document.getElementById("img"+ casa).src="imagens/xis.png";
        //Se o jogador for -1, coloca o desenho da bola
        }else{
            document.getElementById("img"+ casa).src="imagens/bola.png";
        }
...
function confere(){
    ...
    for(i=0;i<Soma.length;i++){
        ...
        if(Soma[i]==-3){
            lGanhou = true;
            sResposta="Fogo Ganhou!!!";
            iPontosO++;
            document.getElementById('bola').innerHTML="Pontos Fogo: "+iPontosO;
            break;
            //Se achou uma soma (3) é porque xis ganhou
        }else if(Soma[i]==3){
            lGanhou=true;
            sResposta="Gelo Ganhou!!!";
            iPontosX++;
            document.getElementById('xis').innerHTML="Pontos Gelo: "+iPontosX;
            break;
        }
    }
    ...
    if(lGanhou || lAcabou){
        ...
        //Muda cor da letra
        document.getElementById('resposta').style.color="#3a7fda";
